...
def batting_average(player_name):   
    ...
    '''
    return round(runs_scored(player_name)/deliveries[(deliveries.player_dismissed == player_name)].shape[0], 2)
...
def bowling_average(player_name):   
    ...
    '''
    return round(runs_conceded(player_name) / wickets_taken(player_name), 2)
